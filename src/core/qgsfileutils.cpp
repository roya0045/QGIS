...
QgsFileSearchTask::QgsFileSearchTask( const QString &file, const QString &basePath, int maxClimbs, int searchCeilling, const QString &currentDir )
  : QgsTask( tr( "searching for %1" ).arg( file ), QgsTask::CanCancel )
  , mFile( file )
  , mBasePath( basePath )
  , mMaxClimbs( maxClimbs )
  , mSearchCeil( searchCeilling )
