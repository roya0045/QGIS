...
void QgsGeoreferencerMainWindow::doGeoreference()
{
  if ( georeference() )
  {
    mMessageBar->pushMessage( tr( "Georeference Successful" ), tr( "Layer was successfully georeferenced." ), Qgis::Success );
    if ( mLoadInQgis )
    {
...
void QgsGeoreferencerMainWindow::showLayerPropertiesDialog()
{
  ...
  {
    mMessageBar->pushMessage( tr( "Layer Properties" ), tr( "Please load a layer to be georeferenced." ), Qgis::Warning );
  }
}
